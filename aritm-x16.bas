1000 REM ARITM V0.3.5 FOR COMMANDER X16 BASIC 2.0 IS FOSS.
...
1110 REM PROGRAM:
1111 REM IF PEEK($400)=0 THEN LOAD "EFFECTS.PRG",8,1,$400
1112 GOTO 1115
1113 MD%=INT((X/Y-INT(X/Y))*Y+.5):RETURN
1114 DIV=INT(X/Y+.5):RETURN
1115 LET R=RND(-TIME):LET R=RND(0)
1116 OPEN 1,0:SCREEN $FF:? CHR$($8E);CHR$($90);CHR$(1);CHR$($9E);CHR$($93)
1117 DIM A(590)
1120 REM LBL C
...
1985 PRINT
1990 IF -1=A% OR ".1"=A$ OR "01"=A$ THEN GOTO 1120:REM C
...
2405 PRINT CHR$(7);:D=100:GOSUB 3402:PRINT CHR$(7);:REM BELL*2:SYS $400:REM PING
...
2820 IF -1=A% OR ".1"=A$ OR "01"=A$ THEN GOTO 1120:REM C
...
3600 RETURN
3610 REM SUB SOUND
3620 PRINT CHR$(7);:REM BELL:SYS $409:REM EXPLODE
3670 LET D=1000:GOSUB 3402:REM DELAY
3690 RETURN
