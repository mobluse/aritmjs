1000 REM ARITM V0.3.4 FOR COMMANDER X16 BASIC 2.0 IS FOSS.
...
1116 OPEN 1,0:PRINT CHR$($90);CHR$(1);CHR$($9E);CHR$($8E):SCREEN 0
1117 DIM A(590)
1120 REM LBL C
...
1985 PRINT
1990 IF -1=A% OR ".1"=A$ OR ",1"=A$ OR "01"=A$ THEN GOTO 1120:REM C
...
2820 IF -1=A% OR ".1"=A$ OR ",1"=A$ OR "01"=A$ THEN GOTO 1120:REM C
