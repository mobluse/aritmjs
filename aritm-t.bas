1000 Rem Aritm v0.3 for TinyBASIC Two is FOSS.
1010 Rem TinyBASIC 2 Flavour: Humbug or Vanilla.
...
1890 Print #1,L," problems left. -1 Esc"
1900 Let T=@(K)
...
2060 Print "Right! ",
2070 If 0>=T%100 Then Goto 2100;Rem EndIf
2080 Let L=L-1
2090 Let @(K)=T-1
2100 Rem Lbl EndIf
2110 Let K=K+1
2120 If 0<L Then Wait Delay,500
...
2180 Print #1,J," is ",R,"."
2190 If 99<=T%100 Then Goto 2220;Rem EndIf
2200 Let L=L+1
2210 Let @(K)=T+1
2220 Rem Lbl End If
2230 Let K=K+1
2240 Wait Delay,1000
