# Aritm v0.3.4 for MicroPython 1.17.0 is FOSS.
...
def sound():
    ...
    # Print a visual indicator instead
    print("🔔")
    time.sleep(0.1)
...
def practiceSession():
    ...
    while l > 0:
        ...
        while k <= u and l > 0:
            cls()
            print(str(l) + " problems left. -1 Esc")
...
def mainMenu():
    ...
    while s < 1 or s > maxOption:
        try:
            s = int(input('Choose 1-' + str(maxOption) + ': '))
        except:
            s = 0
