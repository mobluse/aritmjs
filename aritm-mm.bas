...
2030 If 6=C Then R=I\J
2040 ' Lbl EndIf
2050 If R<>A Then GoTo 2140:' Wrong
2060 Print "Right! ";
...
3180 If 1=S Then GoTo 1870:' K
3190 If 2=S Then GoTo 2430:' E
3200 If 3=S Then GoTo 2910:' H
3210 If 4=S Then GoTo 2940:' A
3220 If 5=S Then GoTo 2970:' Q
3230 End
3240 ' Sub MenuItem
3250 A=A+1
