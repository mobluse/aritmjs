...
1260 FOR I%=0 TO 9
1270 FOR J%=0 TO 9
1280 LET AF#(U%)=100000000#+I%*100000#+J%*1000#+1#
1290 LET U%=U%+1
1300 NEXT J%
1310 NEXT I%
1320 REM Lbl Add2
...
1370 LET AF#(U%)=200000000#+(T1%+I%)*100000#+J%*1000#+1#
1380 LET U%=U%+1
1390 NEXT J%
1400 NEXT I%
1410 REM Lbl Sub1
...
1430 FOR I%=0 TO 9
1440 FOR J%=I% TO 9+I%
1450 LET AF#(U%)=300000000#+J%*100000#+I%*1000#+1#
1460 LET U%=U%+1
1470 NEXT J%
1480 NEXT I%
1490 REM Lbl Sub2
...
1540 LET AF#(U%)=400000000#+(T1%+J%)*100000#+I%*1000#+1#
1550 LET U%=U%+1
1560 NEXT J%
1570 NEXT I%
1580 REM Lbl Mul
...
1600 FOR I%=0 TO 9
1610 FOR J%=0 TO 9
1620 LET AF#(U%)=500000000#+I%*100000#+J%*1000#+1#
1630 LET U%=U%+1
1640 NEXT J%
1650 NEXT I%
1660 REM Lbl Div
...
1710 LET AF#(U%)=600000000#+T1%*100000#+J%*1000#+1#
1720 LET U%=U%+1
1730 NEXT J%
1740 NEXT I%
1750 REM Lbl EndIf
...
1930 LET I%=FNMD%(FNDIV#(T#,100000#),1000#)
1940 PRINT USING "###";I%;
1950 GOSUB 3280:REM Sign
1960 LET J%=FNMD%(FNDIV#(T#,1000#),100#)
1970 PRINT USING "#";J%;
1980 INPUT " = ",A%
...
2060 PRINT "Right! ";
2070 IF 0>=FNMD%(T#,100) THEN GOTO 2100:REM EndIf
2080 LET L%=L%-1
2090 LET AF#(K%)=T#-1#
2100 REM Lbl EndIf
2110 LET K%=K%+1
...
2190 IF 99<=FNMD%(T#,100#) THEN GOTO 2220:REM EndIf
2200 LET L%=L%+1
2210 LET AF#(K%)=T#+1#
2220 REM Lbl EndIf
2230 LET K%=K%+1
...
2300 FOR K%=1 TO U%
2310 LET T#=AF#(K%)
2320 IF 0=FNMD%(T#,100#) THEN GOTO 2350:REM EndIf
2330 LET AF#(N%)=T#
2340 LET N%=N%+1
2350 REM EndIf
2360 NEXT K%
...
2800 IF -1>A% OR 6<A% OR (0=A% AND 0=N%) THEN GOTO 2780:REM Input
