1000 REM ARITM V0.3.4 FOR YABASIC IS FOSS.
...
1114 LET DIV=INT(X/Y+.5):RETURN
1115 LET R=RAN()
1116 REM PRINT CHR$($90);CHR$(1);CHR$($9E);CHR$($8E):SCREEN 0
1117 DIM A(590)
1120 REM LBL C
1130 GOSUB 3410:REM CLS
1140 LET A=0
1150 IF (L>0)*M GOTO 3000:REM CONTMENU
1160 IF 0=M LET M=10
...
1915 LET C=DIV
1920 IF 6=C PRINT "INTEGER PART OF ";
...
1965 LET J=MD
1970 PRINT STR$(J);
1980 INPUT " = " A$:PRINT A$:A=VAL(A$)
1990 IF -1=A OR ".1"=A$ OR "01"=A$ GOTO 1120:REM C
2000 IF (1=C)+(2=C) LET R=I+J:GOTO 2040:REM ENDIF
2010 IF (3=C)+(4=C) LET R=I-J:GOTO 2040:REM ENDIF
2020 IF 5=C LET R=I*J:GOTO 2040:REM ENDIF
2030 IF 6=C LET R=INT(I/J)
2040 REM LBL ENDIF
...
2100 REM LBL ENDIF
2110 LET K=K+1
2120 IF 0<L LET D=500:GOSUB 3402:REM DELAY
...
2770 PRINT STR$(N)
2780 REM LBL INPUT
2790 INPUT "TOGGLE ITEM 1-6, OR CHOOSE 0 OR -1: " A$:A=VAL(A$)
2800 IF (-1>A)+(6<A)+(0=A)*(0=N) GOTO 2780:REM INPUT
...
3120 REM LBL INPUT
3130 PRINT "CHOOSE 1-";
3132 PRINT STR$(4+(L>0));
3140 INPUT ": " A$:S=VAL(A$)
3150 IF (1>S)+(4+(L>0)<S) GOTO 3120:REM INPUT
3160 LET S=S+(L<=0)
...
3270 RETURN
3280 REM SUB SIGN
3290 IF (1=C)+(2=C) PRINT "+";:GOTO 3330:REM ENDIF
3300 IF (3=C)+(4=C) PRINT "-";:GOTO 3330:REM ENDIF
3310 IF 5=C PRINT "*";:GOTO 3330:REM ENDIF
3320 IF 6=C PRINT "/";
3330 REM LBL ENDIF
3340 RETURN
3350 REM SUB POW10
